          ...
          <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <div class='text-left'>
              {data.tickers.map(ticker => {
                  return <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#{ticker}</span>
                })}
                </div>
              ...
              <div class='flex justify-between mt-6'>
                <div class="flex items-center text-left">
                    ...
                    <div class="text-sm">
                      <p class="text-gray-900 leading-none">{data.publisher.name}</p>
